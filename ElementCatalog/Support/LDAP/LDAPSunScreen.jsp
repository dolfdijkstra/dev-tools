...
String defaultPeopleAttrs   = "objectclass=top&objectclass=person&objectclass=organizationalPerson&objectclass=inetorgperson";
String defaultGroupsAttrs   = "objectclass=top&objectclass=organizationalunit";
String reqPeopleAttrs       = "givenName=First Name&sn=Last Name&cn=Common Name&mail=E-Mail";
...
String xcelSitesroot        = "ou=Sites";
String xcelSitenameattr     = "ou";
...
<% if (! (advanced_flag && sitesroles_flag)) { %>
