...
<%
    ...
    String workfolder, filepath;
    String pfile=inipath+Utilities.osSafeSpec("/batch.ini");
    ...
    {    
        ...
        filepath=System.getProperty("user.dir")+workfolder+spath+"Output.html";
    }
    else 
        filepath=workfolder+spath+"Output.html";
