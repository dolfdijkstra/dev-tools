...
%><cs:ftcs><%
ics.SetVar("st_version","3.8.0");
%><satellite:link pagename='Support/css' satellite="true" outstring="cssURL" ><satellite:argument name="v" value='<%= ics.isCacheable("Support/css")?"26": Long.toString(System.currentTimeMillis()) %>'/></satellite:link><%
