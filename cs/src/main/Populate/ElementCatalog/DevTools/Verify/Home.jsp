...
<ul class="entry-header">
    <li class="read-only">
        <h2><a href="ContentServer?pagename=DevTools/Verify/Files/ftcslog">FutureTense Log</a></h2>
        ...
        <li class="read-only">
             <h2><a href="ContentServer?pagename=DevTools/Verify/Cluster/CheckSyncdirTime">CheckSyncdirTime</a></h2>
        ...
        <li class="read-only">
            <h2><a href="ContentServer?pagename=DevTools/Verify/i18n/UnicodeChart">Unicode Chart</a></h2>
            <p>Check the display of different Unicode characters</p>
    </li>
    <li class="read-only">
         <h2><a href="ContentServer?pagename=DevTools/Verify/Cluster/HttpSession">HttpSession</a></h2>
...
<ul class="entry-header">
        <li class="with-care">
             <h2><a href="ContentServer?pagename=DevTools/Verify/Cluster/TestFS">File System Test</a></h2>
             <p>Test the performance of the shared file system.</p>
        </li>
        <li class="with-care">
             <h2><a href="ContentServer?pagename=DevTools/Verify/Cluster/LockTest">LockTest</a></h2>
        ...
        <li class="with-care">
             <h2><a href="ContentServer?pagename=DevTools/Verify/Cluster/ClusterTest">Basic Cluster Test</a></h2>
        ...
        <li class="with-care">
            <h2><a href="ContentServer?pagename=DevTools/Verify/i18n/encoding">Unicode Form Post</a></h2>
...
<ul class="entry-header">
    <li class="dangerous">
         <h2><a href="ContentServer?pagename=DevTools/Verify/xml/exportFront">DB to XML</a></h2>
    ...
    <li class="dangerous">
        <h2><a href="ContentServer?pagename=DevTools/Verify/Cluster/nodeFront">Cluster Nodes</a></h2>
