...
<% if (ics.UserIsMember("SiteGod")){ %>
	...
	<table class="altClass">
      ...
      <td><a href='ContentServer?pagename=DevTools/TCPI/SQL/IndexScript'>View</a></td>
      <td><a href='ContentServer?pagename=DevTools/TCPI/SQL/Download/IndexScript'>Download</a></td>
      ...
      <td>Referential Integrity for Flex Assets</td>
	    <td><a href='ContentServer?pagename=DevTools/TCPI/SQL/Integrity'>View</a></td>
		  <td><a href='ContentServer?pagename=DevTools/TCPI/SQL/Download/Integrity'>Download</a></td>
		...
		<tr>
			...
			<td><a href='ContentServer?pagename=DevTools/TCPI/SQL/AssetScript'>View</a></td>
			<td><a href='ContentServer?pagename=DevTools/TCPI/SQL/Download/AssetScript'>Download</a></td>
		...
		<tr>
			...
			<td><a href='ContentServer?pagename=DevTools/TCPI/SQL/ApprovedAssetDepsAlignment'>View</a></td>
			<td><a href='ContentServer?pagename=DevTools/TCPI/SQL/Download/ApprovedAssetDepsAlignment'>Download</a></td>
      ...
      <td>ApprovedAssetDeps Duplicates</td>
			<td><a href='ContentServer?pagename=DevTools/TCPI/SQL/ApprovedAssetDups'>View</a></td>
			<td><a href='ContentServer?pagename=DevTools/TCPI/SQL/Download/ApprovedAssetDups'>Download</a></td>
			<td><p>This utility generates sql script to:<br/>Remove Duplicates from ApprovedAssetDeps</p></td>
		</tr>
    <tr>
			<td>Drop Temporary Indexes</td>
			<td><a href='ContentServer?pagename=DevTools/TCPI/SQL/DropTempIndexes'>View</a></td>
			<td><a href='ContentServer?pagename=DevTools/TCPI/SQL/Download/DropTempIndexes'>Download</a></td>
		...
		<tr>
			<td>Drop Indexes</td>
			<td><a href='ContentServer?pagename=DevTools/TCPI/SQL/DropIndexes'>View</a></td>
			<td><a href='ContentServer?pagename=DevTools/TCPI/SQL/Download/DropIndexes'>Download</a></td>
...
<% } else { %>
	<ics:callelement element="DevTools/TCPI/LoginForm"/>
<% } %>
