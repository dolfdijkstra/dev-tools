...
<div id="footer"><span style="float:left">Copyright &copy;2003-2012 Oracle Corporation.  All Rights Reserved.</span> <span style="float:right">&nbsp;Version <%= ics.GetVar("st_version") %></span></div>
</cs:ftcs>