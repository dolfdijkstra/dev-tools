...
<p><div style="text-align: center;font-size:1.5em"><u>DEVELOPERS TOOLS DISCLAIMER</u></div>
<p>"Developers Tools" are a set of diagnostic tools distributed by Oracle ("Oracle").
Incorrect usage of the Developers Tools may cause permanent damage to installed Oracle products ("Licensed Software").</p>
<p style="font-size:1.2em">THE USE OF DEVELOPERS TOOLS ARE NOT COVERED UNDER THE ORACLE MAINTENANCE & SUPPORT AGREEMENTS,
ARE NOT INTENDED TO BE USED IN CONNECTION WITH ANYTHING OTHER THAN ORACLE  SOFTWARE.</p>
<p  style="font-size:1.2em"><u>ANY UNAUTHORIZED USE OF DEVELOPERS TOOLS WILL VOID ALL ORACLE REPRESENTATION AND WARRANTIES FOR LICENSED SOFTWARE.</u></p>
<p>Developers Tools are not licensed Oracle products and are provided to Oracle licensees "AS IS".
