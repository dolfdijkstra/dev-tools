...
<%
  ...
  String targetID = ics.GetVar("targetID");
%>

<% if(assetType==null || assetType.trim().equals("")) { %>
<ics:sql sql="SELECT pt.id as targetid, pt.name as name, aa.assettype as assettype, count(distinct aa.assetid) as num, count(*) as num2
